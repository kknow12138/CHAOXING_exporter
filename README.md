...
### v1.4.0 · 2026-06-14 — 雨课堂导出增强

- 新增雨课堂 AI 学习空间作业页抓取路径，支持从作业节点接口直接拉取题目。
- 新增雨课堂 studentCards 习题集页面导出，可提取题干、选项、正确答案并生成可打印 HTML。
- 修复雨课堂随机字体和二次解密导致的乱码/错字问题。
- 修复课程知识点目录页误抓整页文本的问题，优先导出当前作业测试题。
- 支持 AI 学习空间作业导出为 Word 或 HTML，保留题目图片、答案与解析。
- 更新弹窗样式、测试说明与安装文档，版本号同步提升到 1.4.0。
